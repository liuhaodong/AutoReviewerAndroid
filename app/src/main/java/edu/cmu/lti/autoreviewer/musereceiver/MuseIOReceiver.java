package edu.cmu.lti.autoreviewer.musereceiver;
...
public class MuseIOReceiver {
     ...
     *
     * @param port Specified port.
     * @param udp  Specified communication protocol. True if using UDP, otherwise
     *             using TCP.
     */
     ...
     *
     * @throws java.io.IOException if the socket is already bound.
     */
